  ...
  return (
    <main className='mx-auto flex min-h-svh w-full max-w-7xl min-w-0 flex-col overflow-y-auto bg-canvas px-4 pb-12 text-clt-2 sm:px-6 lg:px-8'>
      ...
      {error !== null ? (
        ...
        <section aria-label='Histórico de Empréstimos' className='mt-7 rounded-xl border border-borderMy bg-surface p-4 sm:p-6'>
          ...
          <ResponsiveTable label='Histórico de Empréstimos' columns={columns}>
            ...
            <div className='w-full min-h-72'>
              {current.length === 0 ? <p className='p-10 text-center text-clt-1'>Nenhum dado disponível para exibição.</p> : current.map((loan, index) => (
