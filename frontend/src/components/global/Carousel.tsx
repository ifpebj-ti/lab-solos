      ...
      <div className=' w-full h-full flex flex-wrap lg:flex-nowrap items-center justify-center gap-5 landscape:gap-2 lg:gap-2 '>
        {Array.from({ length: 4 }, (_, i) => {
          ...
          return (
            ...
            >
              <div className=' w-full h-full rounded-md flex flex-col items-center justify-center hover:bg-green-400 transition-all ease-in-out duration-200 shadow-md gap-2'>
                <img
