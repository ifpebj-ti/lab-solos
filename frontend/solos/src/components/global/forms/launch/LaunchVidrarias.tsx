...
const submitLaunchVidrariasSchema = z.object({
...
type LaunchVidrariasFormData = z.infer<typeof submitLaunchVidrariasSchema>;

function LaunchVidrarias() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<LaunchVidrariasFormData>({
    resolver: zodResolver(submitLaunchVidrariasSchema),
  });
...
export default LaunchVidrarias;
