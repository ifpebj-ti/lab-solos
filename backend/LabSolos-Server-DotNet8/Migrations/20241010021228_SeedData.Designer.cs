...
namespace LabSolos_Server_DotNet8.Migrations
{
    ...
    [Migration("20241010021228_SeedData")]
            ...
            modelBuilder.Entity("LabSolos_Server_DotNet8.Models.Quimico", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Codigo = "Q123",
                            DataValidade = new DateTime(2025, 10, 9, 23, 12, 27, 790, DateTimeKind.Local).AddTicks(4557),
                            ...
                            Status = true,
                            Tipo = 0,
                            UltimaModificacao = new DateTime(2024, 10, 9, 23, 12, 27, 790, DateTimeKind.Local).AddTicks(4589),
                            Catmat = "CATMAT-01",
                            Formula = "H2O",
                            Grupo = 0,
                            UnidadeMedida = 0
            ...
            modelBuilder.Entity("LabSolos_Server_DotNet8.Models.Vidraria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            Codigo = "V456",
                            DataValidade = new DateTime(2026, 10, 9, 23, 12, 27, 790, DateTimeKind.Local).AddTicks(4783),
                            ...
                            Status = true,
                            Tipo = 1,
                            UltimaModificacao = new DateTime(2024, 10, 9, 23, 12, 27, 790, DateTimeKind.Local).AddTicks(4791),
                            Volumetria = 500.0
                        });
                });
